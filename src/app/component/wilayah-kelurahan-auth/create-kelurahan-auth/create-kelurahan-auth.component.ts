...
@Component({
  selector: 'app-create-kelurahan-auth',
  templateUrl: './create-kelurahan-auth.component.html',
  styleUrls: ['./create-kelurahan-auth.component.css'],
})
export class CreateKelurahanAuthComponent implements OnInit {
  constructor(
    private title: Title,
  ...
  ngOnInit(): void {
    this.title.setTitle('Buat Kelurahan Auth');
